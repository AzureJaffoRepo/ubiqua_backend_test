...
var PokemonFetchs = /** @class */ (function () {
    ...
    PokemonFetchs.prototype.GetAllKantoPokemonFetch = function () {
        var _this = this;
    ...
    PokemonFetchs.prototype.GetPokemonInfoFetch = function (id) {
        var _this = this;
        return new Promise(function (resolve, reject) {
    ...
    return PokemonFetchs;
}());
exports.default = PokemonFetchs;
